...
const DESCRIPTION =
  "The control plane for browser fleets. One endpoint, any provider: failover, persistent profiles, session replay, REST API, MCP server, dashboard. Think OpenRouter, for browsers.";
