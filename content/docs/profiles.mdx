...
**Cloud SaaS dashboard:** on the Providers page, open the "Which profiles it serves" dropdown for each provider and pick the profile it serves. The options are:
