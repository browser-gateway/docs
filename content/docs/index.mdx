---
title: Introduction
description: browser-gateway is OpenRouter for browsers.
---

**OpenRouter for browsers.** You bring the backends, we handle the routing, state, and dashboard.

**browser-gateway routes WebSocket connections across any browser provider you already have**. Browserless, Steel, Browserbase, Cloudflare Browser Rendering, raw Chrome, or [your own runtime](/browserserve), and adds the layer everyone reinvents on top: profile capture, session replay, cost control, observability.
