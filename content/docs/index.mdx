---
title: Introduction
description: browser-gateway is OpenRouter for cloud browsers.
---

**OpenRouter for cloud browsers.** You bring the backends, we handle the routing, state, and dashboard.
