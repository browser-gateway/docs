...
See the full [REST API Reference](/rest-api) for all options.
...
- [REST API Reference](/rest-api) - Screenshot, content extraction, and scraping endpoints
- [Web Dashboard](/dashboard) - Every page explained with what you can do
- [Configuration Reference](/configuration) - Every config option explained
- [How Failover Works](/operating/failover) - Understanding automatic failover
- [Load Balancing](/operating/load-balancing) - 5 routing strategies explained with real examples
- [Request Queue](/operating/queue) - What happens when all providers are busy
- [Webhooks](/operating/webhooks) - Get notified when providers go down or recover
- [Supported Providers](/providers) - Provider types and connection modes
- [Docker Deployment](/operating/docker) - Running in containers
