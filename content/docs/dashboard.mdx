...
A live view of a browser session: navigate with back, forward, and reload, and watch the page render in real time. Useful for confirming a provider works and for debugging what a session actually saw.
